...
data = []
with open('graphs/db/GREC-GED/GREC-low-level-info/GREC5-lowlevelinfo.csv') as csv_file:
    for row in csv.DictReader(csv_file, delimiter=';'):
        ...
        process = subprocess.Popen('./max-weight-clique/colour_order -t ' + filename, shell=True, stdout=subprocess.PIPE)
        line = ''
